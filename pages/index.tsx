  ...
  return (
    <div className="content pages">
      ...
      <p>
        ...
        learn new technologies. Currently I am programming my new downloader app, Downstream
        while also making a
      ...
      <ul className="experience-list">
        <li>
          <Link href="https://codeday.org/ba">CodeDay Bay Area</Link> - Volunteer - Jan 2020 to Today
        </li>
        <li>
      ...
      <ul className="education-list">
        <li>
          <Link href="https://upasv.org">University Preparatory Academy</Link> - 3.7 GPA - 2017 to Today
        </li>
        <li>
          <Link href="https://www.gavilan.edu/"> Gavilan Edu</Link> - 4.0 GPA - Aug 2020 to Dec 2022
        </li>
      </ul>
